<?php  
	...
	$level = mysqli_query($conn, "SELECT * FROM level ORDER BY nama_level ASC");
	...
	if ($_POST) {
		...
		$simpan = mysqli_query($conn, "INSERT INTO petugas VALUES
		('', $id_level, '$nama_petugas', '$username', '$password')");
