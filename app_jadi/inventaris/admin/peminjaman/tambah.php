<?php  
	...
	if ($_POST) {
		...
		$simpan_pinjam = mysqli_query($connect, "INSERT INTO tb_peminjaman VALUES('', '$pegawai', '$tanggal_pinjam', '', '$status_pinjam')");

		if ($simpan_pinjam) {
			$id = $connect -> insert_id;

			$simpan_detail = mysqli_query($connect, "INSERT INTO tb_detail_pinjam VALUES ( '', '$id', '$barang', '$jumlah' )");
